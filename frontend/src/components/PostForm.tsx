...
import { useWriteForumCreatePoll, useWriteForumCreatePost } from "../contracts/generated";
            ...
            {pollElementVisible && (
              <>
                ...
                <input
                  ...
                  onChange={(e) => setPollDetails({ ...pollDetails, option1: e.target.value })}
                  required
                />
                <input
                  type="text"
                  ...
                  onChange={(e) => setPollDetails({ ...pollDetails, option2: e.target.value })}
                  required
                />
              </>
            )}
            <div className={styles.bottomPrimary}>
              <div className={styles.secondary}>
                <label htmlFor="spoiler">
                  <button type="button" onClick={() => setPost({ ...post, spoil: !post.spoil })}>
                    <FontAwesomeIcon
                      icon={faWarning}
                ...
                <label htmlFor="hasPoll">
                  <button type="button" onClick={() => setPollElementVisible(!pollElementVisible)}>
                    <FontAwesomeIcon
                      icon={faPoll}
